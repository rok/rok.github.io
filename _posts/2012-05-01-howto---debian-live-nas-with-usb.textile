...
I had an old computer or two lying around, so I decided to cannabalize them and make a cheap "NAS":http://en.wikipedia.org/wiki/Network-attached_storage with the old disks. The main ideaa were to keep it easy to maintain and to buy no extra components.
Here's what I did:
